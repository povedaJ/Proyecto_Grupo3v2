...
public class ControlCostosController implements Initializable {
    ...
    private domain.queue.HearderLinkedQueue hLQ1 = util.Utility.getHeaderLinkedQueue();

    private HearderLinkedQueue hLQ2 = util.Utility.getHeaderLinkedQueue();
    @javafx.fxml.FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        product = new AVL();
        Product p1 = new Product("Martillo", 20.000, 4, 1, 1);
        Product p2 = new Product("Tornillo", 20.000, 4, 1, 1);
