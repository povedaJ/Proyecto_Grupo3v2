...
public class HearderLinkedQueue implements Queue {
    ...
    private domain.Node front;//apuntador al anterior
    private domain.Node rear;//apuntador al posterior
    private int count;// control de elementos encolados

    public HearderLinkedQueue() {
        this.front = this.rear = new domain.Node();//node en null
        this.count = 0;
    }
    ...
    @Override
    public void clear() {
        this.front = this.rear = new domain.Node();
        this.count = 0;
    }
    ...
    public void enQueue(Object element) throws QueueException {
        domain.Node newNode = new Node(element);
        rear.next = newNode;
        rear= newNode;
